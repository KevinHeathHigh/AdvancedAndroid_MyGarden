...
public class PlantWateringService extends IntentService {
    ...
    // TODO/COMPLETED (3): Create a new action ACTION_UPDATE_PLANT_WIDGETS to handle updating widget
    // UI and implement handleActionUpdatePlantWidgets to query the plant closest to dying and call
    ...
    private void handleActionUpdatePlantWidgets() {
        ...
        int imgRes = R.drawable.grass; // Default image incase our garden is empty
