...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        // Get currnet width to decide on single plant vs garden grid view
        ...
        if (width < 300) {
            ...
            rv = getGardentGridRemoteView(context);
        }
    ...
    private static RemoteViews getGardentGridRemoteView(Context context) {
